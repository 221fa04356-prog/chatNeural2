...
export default function Chat() {
    ...
    useEffect(() => {
        ...
        if (container) {
            ...
            // Do not apply this custom zoom on mobile or tablet devices, as they handle this via viewport natively.
            // Applying this on mobile breaks the flex layout and causes UI to shrink and overflow.
            const isTabletOrMobile = window.innerWidth <= 1024;

            if (internalZoom >= 0.25 && internalZoom <= 5.0 && !isTabletOrMobile) {
                ...
                // Reset transform-origin and background color for mobile or default 100% view
